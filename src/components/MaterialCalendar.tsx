...
export default function MaterialMaterialCalendar({ onSelectProduct }: MaterialCalendarProps) {
                ...
                {filteredProducts.map((product) => {
                  ...
                  return (
                    <div key={product.id} className="grid grid-cols-[250px_repeat(36,1fr)] gap-1 items-center">
                      {/* 商品情報 */}
                      <div 
                        className="p-3 bg-card border rounded cursor-pointer hover:shadow-md transition-shadow"
